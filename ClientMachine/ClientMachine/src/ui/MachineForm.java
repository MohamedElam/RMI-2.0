...
public class MachineForm extends javax.swing.JInternalFrame {
    ...
    public void load(){
     ...
     public void loadSalles() {
        try {
            for(Salles s : daoSalle.findAll())
            {
                sallesComboBox.addItem(s);
            }
        } catch (RemoteException ex) {
            Logger.getLogger(MachineForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public MachineForm() {
        ...
        try {
            ...
            daoSalle = (IDao<Salles>) Naming.lookup("rmi://localhost:1099/dao/salles");
    ...
    private void initComponents() {
        ...
        sallesComboBox = new javax.swing.JComboBox();
        ...
        sallesComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sallesComboBoxActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(sallesComboBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(sallesComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void bnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnAddActionPerformed
        try {
            ...
            Salles salle = (Salles) sallesComboBox.getSelectedItem();
    ...
    private void bnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnUpdateActionPerformed
            ...
            this.selectedMachine.setSalle((Salles) sallesComboBox.getSelectedItem());
            ...
            txtMarque.setText("");
            txtPrix.setText("");
            sallesComboBox.setSelectedItem(null);
        } catch (RemoteException ex) {
            Logger.getLogger(MachineForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void listMachinesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listMachinesMouseClicked
       ...
       DefaultTableModel tblModel = (DefaultTableModel) listMachines.getModel();
        ...
        Salles salle = (Salles) tblModel.getValueAt(listMachines.getSelectedRow(), 4);
        ...
        sallesComboBox.getModel().setSelectedItem(salle);
    ...
    private void SearchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchBtnActionPerformed
        // TODO add your handling code here:
// TODO add your handling code here:
        Salles salles = (Salles) sallesComboBox.getSelectedItem();
        
        try {
            List <Machine> machines = dao.findMachinesBySalleId(salles.getId());
              model.setRowCount(0);
    ...
    private void sallesComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sallesComboBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_sallesComboBoxActionPerformed
    ...
    private javax.swing.JComboBox sallesComboBox;
